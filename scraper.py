...
searchDb = open('listaproduse.txt', 'r')
...
for line in searchDb:
    ...
    maxProducts = len(soup.find_all('div', attrs={'class':'js-product-data'}))
    ...
    for pag in range (1, maxPage):
        print('Procesez pagina ' + str(pag) + ' din ' + str(maxPage) + ' care are '+ str(maxProducts) + 'produse '+'....' + '\n')
